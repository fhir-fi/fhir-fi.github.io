  ...
  return (
    <Demo roles={roles} location={location}>
      ...
      <section id="remote-health">
        ...
        <p>
          Radically increase effectiveness of care both domestically and globally, offering
          citizens the opportunity to actively participate in their own care by putting together
          scattered services, offering capabilities for home care and monitoring, and at the same
          time saving resources for all parties.
        </p>
        <p>
          Fujitsu Remote Health solutions include <strong>Home Dialysis</strong> and <strong
          >eMOM</strong> solutions that are using HL7 FHIR. We have integrated solutions to <Link
        ...
        <p>
          ...
          before and after birth. These solutions have been developed within the framework of
          the <a href="https://www.newlife-kdt.eu/"><strong>Newlife EU project</strong></a>.
        </p>
        <p>
          In collaboration with our partners, we have developed the Smart Baby Bed, and during the
          demonstration, we will also present the <a href="https://zoundream.com/"><strong
          >Zoundream</strong></a> cry analysis sensor, which utilizes FHIR in accordance with
          the <strong>Implementation Guide (IG)</strong> Fujitsu has created during the project.
